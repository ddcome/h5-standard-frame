...
export const EASEMOB_CONFIG = {
  host: 'https://a1.easemob.com',
  appKey: '1117200302065570#wg',
  orgname: '1117200302065570',
  appname: 'wg',
  clientId: 'YXA6Z6oKWuUHRtGidoJrGcKC2w',
  clientSecret: 'YXA6vuYTj_JmDCqkYaz4ls-vOMhmC1s'
};
